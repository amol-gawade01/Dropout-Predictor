...
export const facultyApi = {
  ...
  reportDetails: (code) => cachedGet(`/faculty/reports/${encodeURIComponent(code)}`),
  reportPreview: (code) => api.get(`/faculty/reports/${encodeURIComponent(code)}/preview.pdf`, { responseType: "blob" }),
  sendReport: (code, payload) => api.post(`/faculty/reports/${encodeURIComponent(code)}/send`, payload),
